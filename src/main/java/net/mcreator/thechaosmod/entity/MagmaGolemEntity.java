...
import net.mcreator.thechaosmod.block.BiomespecificblockBlock;
...
public class MagmaGolemEntity extends TheChaosModModElements.ModElement {
	public static EntityType entity = null;
	public MagmaGolemEntity(TheChaosModModElements instance) {
		super(instance, 532);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("magma_golem")
						.setRegistryName("magma_golem");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -52429, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("magma_golem_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIronGolemModel(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_chaos_mod:textures/magma_golem_story_mode.png");
					}
				};
			});
		}
	...
	private void setupAttributes() {
		...
		ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 6);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(BiomespecificblockBlock.block.getDefaultState().getBlock(), this, 20, (int) 10));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DimensionalLuckyBlockBlock.block, (int) (1)));
		}
