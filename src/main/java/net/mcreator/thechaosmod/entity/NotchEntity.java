...
public class NotchEntity extends TheChaosModModElements.ModElement {
	public static EntityType entity = null;
	public NotchEntity(TheChaosModModElements instance) {
		super(instance, 527);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("notch")
						.setRegistryName("notch");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("notch_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelherobrine(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_chaos_mod:textures/notch.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			super(type, world);
			experienceValue = 11111;
			setNoAI(false);
			setCustomName(new StringTextComponent("notch"));
