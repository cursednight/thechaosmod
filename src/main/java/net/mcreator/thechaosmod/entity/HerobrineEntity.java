...
public class HerobrineEntity extends TheChaosModModElements.ModElement {
	public static EntityType entity = null;
	public HerobrineEntity(TheChaosModModElements instance) {
		super(instance, 403);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("herobrine")
						.setRegistryName("herobrine");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("herobrine_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelherobrine(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_chaos_mod:textures/herobrine_defensores_de_minecraft.png");
					}
				};
			});
		}
	...
	private void setupAttributes() {
		...
		ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 45);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			setCustomName(new StringTextComponent("herobrine"));
		...
		private final ServerBossInfo bossInfo = new ServerBossInfo(this.getDisplayName(), BossInfo.Color.WHITE, BossInfo.Overlay.NOTCHED_20);
		@Override
