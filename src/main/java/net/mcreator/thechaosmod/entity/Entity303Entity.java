...
public class Entity303Entity extends TheChaosModModElements.ModElement {
	public static EntityType entity = null;
	public Entity303Entity(TheChaosModModElements instance) {
		super(instance, 529);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("entity_303")
						.setRegistryName("entity_303");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -52429, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("entity_303_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelherobrine(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_chaos_mod:textures/notch_1.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			super(type, world);
			experienceValue = 99999;
			setNoAI(false);
			setCustomName(new StringTextComponent("entity 303"));
			setCustomNameVisible(true);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(TotemOfAgilityItem.block, (int) (1)));
