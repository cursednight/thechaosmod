...
import net.mcreator.thechaosmod.procedures.PoisenRifleBulletHitsPlayerProcedure;
...
public class PoisenRifleItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:poisen_rifle")
	public static final Item block = null;
	@ObjectHolder("the_chaos_mod:entitybulletpoisen_rifle")
	public static final EntityType arrow = null;
	public PoisenRifleItem(TheChaosModModElements instance) {
		super(instance, 397);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpoisen_rifle").setRegistryName("entitybulletpoisen_rifle"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 10, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				PoisenRifleBulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
