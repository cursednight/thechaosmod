...
public class WitheredGemItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:withered_gem")
	public static final Item block = null;
	public WitheredGemItem(TheChaosModModElements instance) {
		super(instance, 550);
	}
