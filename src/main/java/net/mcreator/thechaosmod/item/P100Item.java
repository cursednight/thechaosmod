...
public class P100Item extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:p_100")
	public static final Item block = null;
	public P100Item(TheChaosModModElements instance) {
		super(instance, 559);
	}
