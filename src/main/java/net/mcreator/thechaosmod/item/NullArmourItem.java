...
public class NullArmourItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:null_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_chaos_mod:null_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_chaos_mod:null_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_chaos_mod:null_armour_boots")
	public static final Item boots = null;
	public NullArmourItem(TheChaosModModElements instance) {
		super(instance, 515);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "the_chaos_mod:textures/null.png";
			}
		}.setRegistryName("null_armour_helmet"));
		...
		}.setRegistryName("null_armour_chestplate"));
		...
		}.setRegistryName("null_armour_leggings"));
	}
