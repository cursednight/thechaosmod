...
public class NightmareSteveArmourItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:nightmare_steve_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_chaos_mod:nightmare_steve_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_chaos_mod:nightmare_steve_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_chaos_mod:nightmare_steve_armour_boots")
	public static final Item boots = null;
	public NightmareSteveArmourItem(TheChaosModModElements instance) {
		super(instance, 521);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedRightArm = new Modelherobrine().RightLeg;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "the_chaos_mod:textures/nightmare_steve.png";
			}
		}.setRegistryName("nightmare_steve_armour_chestplate"));
	}
