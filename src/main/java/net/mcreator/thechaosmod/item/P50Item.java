...
public class P50Item extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:p_50")
	public static final Item block = null;
	public P50Item(TheChaosModModElements instance) {
		super(instance, 561);
	}
