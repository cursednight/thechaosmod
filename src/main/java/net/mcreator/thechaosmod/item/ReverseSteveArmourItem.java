...
public class ReverseSteveArmourItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:reverse_steve_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_chaos_mod:reverse_steve_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_chaos_mod:reverse_steve_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_chaos_mod:reverse_steve_armour_boots")
	public static final Item boots = null;
	public ReverseSteveArmourItem(TheChaosModModElements instance) {
		super(instance, 524);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "the_chaos_mod:textures/reverse_steve.png";
			}
		}.setRegistryName("reverse_steve_armour_chestplate"));
	}
