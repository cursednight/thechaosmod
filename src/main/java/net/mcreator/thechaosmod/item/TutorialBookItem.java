...
public class TutorialBookItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:tutorial_book")
	public static final Item block = null;
	public TutorialBookItem(TheChaosModModElements instance) {
		super(instance, 499);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GuideBookP1Gui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tutorial Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GuideBookP1Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
