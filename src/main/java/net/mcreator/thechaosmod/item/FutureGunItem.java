...
import net.mcreator.thechaosmod.procedures.FutureGunBulletHitsPlayerProcedure;
...
public class FutureGunItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:future_gun")
	public static final Item block = null;
	@ObjectHolder("the_chaos_mod:entitybulletfuture_gun")
	public static final EntityType arrow = null;
	public FutureGunItem(TheChaosModModElements instance) {
		super(instance, 382);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfuture_gun").setRegistryName("entitybulletfuture_gun"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 5f, 40, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				FutureGunBulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
