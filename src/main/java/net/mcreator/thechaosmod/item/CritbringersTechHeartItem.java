...
public class CritbringersTechHeartItem extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:critbringers_tech_heart")
	public static final Item block = null;
	public CritbringersTechHeartItem(TheChaosModModElements instance) {
		super(instance, 501);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("critbringers_tech_heart");
		}
