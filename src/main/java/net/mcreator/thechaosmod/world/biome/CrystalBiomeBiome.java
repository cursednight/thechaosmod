...
import net.mcreator.thechaosmod.block.CrystalTreeLogBlock;
import net.mcreator.thechaosmod.block.CrystalTreeLeavesBlock;
import net.mcreator.thechaosmod.block.CrystalStoneBlock;
import net.mcreator.thechaosmod.block.CrystalGrassBlock;
...
public class CrystalBiomeBiome extends TheChaosModModElements.ModElement {
	public static Biome biome;
	public CrystalBiomeBiome(TheChaosModModElements instance) {
		super(instance, 874);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(CrystalGrassBlock.block.getDefaultState(),
								CrystalStoneBlock.block.getDefaultState(), CrystalStoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.TREE
								.withConfiguration(
										(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(CrystalTreeLogBlock.block.getDefaultState()),
												new SimpleBlockStateProvider(CrystalTreeLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("the_chaos_mod:crystal_biome"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("crystal_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("crystal_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("crystal_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
