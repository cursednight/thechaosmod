...
import net.mcreator.thechaosmod.block.PineLogBlock;
import net.mcreator.thechaosmod.block.Grass2Block;
...
public class NatureBiome1Biome extends TheChaosModModElements.ModElement {
	public static Biome biome;
	public NatureBiome1Biome(TheChaosModModElements instance) {
		super(instance, 622);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Grass2Block.block.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(PineLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("the_chaos_mod:nature_biome_1"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("nature_biome_1_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nature_biome_1_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nature_biome_1_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
