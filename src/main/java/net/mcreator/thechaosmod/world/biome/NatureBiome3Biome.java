...
import net.mcreator.thechaosmod.block.Grass3Block;
import net.mcreator.thechaosmod.block.GoldLayeredWoodLogBlock;
import net.mcreator.thechaosmod.block.DirtBlock;
...
public class NatureBiome3Biome extends TheChaosModModElements.ModElement {
	public static Biome biome;
	public NatureBiome3Biome(TheChaosModModElements instance) {
		super(instance, 740);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Grass3Block.block.getDefaultState(),
								DirtBlock.block.getDefaultState(), DirtBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(GoldLayeredWoodLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("the_chaos_mod:nature_biome_3"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("nature_biome_3_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nature_biome_3_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("nature_biome_3_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
