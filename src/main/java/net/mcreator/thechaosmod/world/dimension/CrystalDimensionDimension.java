...
import net.mcreator.thechaosmod.item.CrystalDimensionItem;
import net.mcreator.thechaosmod.block.CrystalStoneBlock;
...
public class CrystalDimensionDimension extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public CrystalDimensionDimension(TheChaosModModElements instance) {
		super(instance, 877);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(CrystalStoneBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("the_chaos_mod:crystal_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("crystal_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("crystal_dimension_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("crystal_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new CrystalDimensionItem().setRegistryName("crystal_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("the_chaos_mod:crystal_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("the_chaos_mod:crystal_dimension")));
				} else {
					entity.func_242279_ag();
