...
public class PortalStructure extends TheChaosModModElements.ModElement {
	public PortalStructure(TheChaosModModElements instance) {
		super(instance, 414);
				...
				if ((random.nextInt(1000000) + 1) <= 4000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_chaos_mod", "ld_portal_001-hell"));
						if (template == null)
							return false;
