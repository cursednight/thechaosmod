...
public class Town1Structure extends TheChaosModModElements.ModElement {
	public Town1Structure(TheChaosModModElements instance) {
		super(instance, 412);
				...
				if ((random.nextInt(1000000) + 1) <= 3000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_chaos_mod", "micmokum-town1"));
						if (template == null)
							return false;
