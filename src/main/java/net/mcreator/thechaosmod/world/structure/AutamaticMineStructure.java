...
public class AutamaticMineStructure extends TheChaosModModElements.ModElement {
	public AutamaticMineStructure(TheChaosModModElements instance) {
		super(instance, 413);
				...
				if ((random.nextInt(1000000) + 1) <= 500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("the_chaos_mod", "mining_turtle"));
						if (template == null)
							return false;
