...
public class CopperBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(TheChaosModModElements instance) {
		super(instance, 93);
	}
