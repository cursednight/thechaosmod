...
public class RedEmeraldOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:red_emerald_ore")
	public static final Block block = null;
	public RedEmeraldOreBlock(TheChaosModModElements instance) {
		super(instance, 480);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_emerald_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedEmeraldItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 2)).range(23).square().func_242731_b(7));
	}
}
