...
public class CrystalTreeFenceBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_fence")
	public static final Block block = null;
	public CrystalTreeFenceBlock(TheChaosModModElements instance) {
		super(instance, 765);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_fence");
		}
