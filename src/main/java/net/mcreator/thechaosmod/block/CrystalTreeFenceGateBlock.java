...
public class CrystalTreeFenceGateBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_fence_gate")
	public static final Block block = null;
	public CrystalTreeFenceGateBlock(TheChaosModModElements instance) {
		super(instance, 766);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_fence_gate");
		}
