...
public class PineLeavesBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_leaves")
	public static final Block block = null;
	public PineLeavesBlock(TheChaosModModElements instance) {
		super(instance, 657);
	}
