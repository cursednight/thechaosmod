...
public class TittaniumOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:tittanium_ore")
	public static final Block block = null;
	public TittaniumOreBlock(TheChaosModModElements instance) {
		super(instance, 845);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 7)).range(63).square().func_242731_b(4));
	}
}
