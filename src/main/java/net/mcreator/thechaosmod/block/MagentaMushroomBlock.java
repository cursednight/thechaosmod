...
public class MagentaMushroomBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:magenta_mushroom")
	public static final Block block = null;
	public MagentaMushroomBlock(TheChaosModModElements instance) {
		super(instance, 702);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("magenta_mushroom");
		}
