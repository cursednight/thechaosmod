...
public class WillowWoodBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:willow_wood")
	public static final Block block = null;
	public WillowWoodBlock(TheChaosModModElements instance) {
		super(instance, 670);
	}
