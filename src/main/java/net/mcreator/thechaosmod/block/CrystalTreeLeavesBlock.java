...
public class CrystalTreeLeavesBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_leaves")
	public static final Block block = null;
	public CrystalTreeLeavesBlock(TheChaosModModElements instance) {
		super(instance, 762);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_leaves");
		}
