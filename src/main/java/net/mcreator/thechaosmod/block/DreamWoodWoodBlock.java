...
public class DreamWoodWoodBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_wood")
	public static final Block block = null;
	public DreamWoodWoodBlock(TheChaosModModElements instance) {
		super(instance, 743);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_wood");
		}
