...
public class CrystalTreeLogBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_log")
	public static final Block block = null;
	public CrystalTreeLogBlock(TheChaosModModElements instance) {
		super(instance, 760);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_log");
		}
