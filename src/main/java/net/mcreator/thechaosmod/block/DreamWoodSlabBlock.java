...
public class DreamWoodSlabBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_slab")
	public static final Block block = null;
	public DreamWoodSlabBlock(TheChaosModModElements instance) {
		super(instance, 748);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_slab");
		}
