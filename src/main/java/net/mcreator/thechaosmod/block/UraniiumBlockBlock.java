...
public class UraniiumBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:uraniium_block")
	public static final Block block = null;
	public UraniiumBlockBlock(TheChaosModModElements instance) {
		super(instance, 870);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uraniium_block");
		}
