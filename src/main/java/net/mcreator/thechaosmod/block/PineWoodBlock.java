...
public class PineWoodBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_wood")
	public static final Block block = null;
	public PineWoodBlock(TheChaosModModElements instance) {
		super(instance, 654);
	}
