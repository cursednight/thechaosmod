...
public class PineLogBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_log")
	public static final Block block = null;
	public PineLogBlock(TheChaosModModElements instance) {
		super(instance, 655);
	}
