...
import net.mcreator.thechaosmod.item.SulferDustItem;
...
public class SulferOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:sulfer_ore")
	public static final Block block = null;
	public SulferOreBlock(TheChaosModModElements instance) {
		super(instance, 86);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SulferDustItem.block, (int) (3)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 5)).range(100).square().func_242731_b(7));
	}
}
