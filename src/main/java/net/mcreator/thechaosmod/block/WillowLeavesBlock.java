...
public class WillowLeavesBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:willow_leaves")
	public static final Block block = null;
	public WillowLeavesBlock(TheChaosModModElements instance) {
		super(instance, 673);
	}
