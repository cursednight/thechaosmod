...
import net.mcreator.thechaosmod.item.FrostOpalItem;
...
public class FrostOpalOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:frost_opal_ore")
	public static final Block block = null;
	public FrostOpalOreBlock(TheChaosModModElements instance) {
		super(instance, 419);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frost_opal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FrostOpalItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(33).square().func_242731_b(5));
	}
}
