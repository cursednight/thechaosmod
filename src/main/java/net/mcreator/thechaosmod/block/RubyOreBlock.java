...
import net.mcreator.thechaosmod.item.RubyItem;
...
public class RubyOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(TheChaosModModElements instance) {
		super(instance, 704);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 2)).range(18).square().func_242731_b(3));
	}
}
