...
public class AmythesttBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:amythestt_block")
	public static final Block block = null;
	public AmythesttBlockBlock(TheChaosModModElements instance) {
		super(instance, 801);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amythestt_block");
		}
