...
public class DreamWoodFenceGateBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_fence_gate")
	public static final Block block = null;
	public DreamWoodFenceGateBlock(TheChaosModModElements instance) {
		super(instance, 750);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_fence_gate");
		}
