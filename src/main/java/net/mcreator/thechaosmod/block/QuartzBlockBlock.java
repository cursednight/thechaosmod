...
public class QuartzBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:quartz_block")
	public static final Block block = null;
	public QuartzBlockBlock(TheChaosModModElements instance) {
		super(instance, 191);
	}
