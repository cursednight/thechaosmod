...
public class EnduriumOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:endurium_ore")
	public static final Block block = null;
	public EnduriumOreBlock(TheChaosModModElements instance) {
		super(instance, 27);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 5)).range(64).square().func_242731_b(4));
	}
}
