...
public class CrystalTreePlanksBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_planks")
	public static final Block block = null;
	public CrystalTreePlanksBlock(TheChaosModModElements instance) {
		super(instance, 761);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_planks");
		}
