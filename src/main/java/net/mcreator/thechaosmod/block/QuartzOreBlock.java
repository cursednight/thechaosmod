...
import net.mcreator.thechaosmod.item.QuartzItem;
...
public class QuartzOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:quartz_ore")
	public static final Block block = null;
	public QuartzOreBlock(TheChaosModModElements instance) {
		super(instance, 190);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(QuartzItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
