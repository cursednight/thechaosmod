...
public class UraniiumOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:uraniium_ore")
	public static final Block block = null;
	public UraniiumOreBlock(TheChaosModModElements instance) {
		super(instance, 869);
