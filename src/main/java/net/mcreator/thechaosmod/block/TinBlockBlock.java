...
public class TinBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:tin_block")
	public static final Block block = null;
	public TinBlockBlock(TheChaosModModElements instance) {
		super(instance, 143);
	}
