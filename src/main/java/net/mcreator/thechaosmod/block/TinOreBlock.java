...
public class TinOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:tin_ore")
	public static final Block block = null;
	public TinOreBlock(TheChaosModModElements instance) {
		super(instance, 142);
