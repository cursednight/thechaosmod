...
public class GoldLayeredWoodSlabBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_slab")
	public static final Block block = null;
	public GoldLayeredWoodSlabBlock(TheChaosModModElements instance) {
		super(instance, 729);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_slab");
		}
