...
public class CrystalStoneBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_stone")
	public static final Block block = null;
	public CrystalStoneBlock(TheChaosModModElements instance) {
		super(instance, 776);
	}
