...
public class PineSlabBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_slab")
	public static final Block block = null;
	public PineSlabBlock(TheChaosModModElements instance) {
		super(instance, 659);
	}
