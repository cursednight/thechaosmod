...
import net.mcreator.thechaosmod.item.NetheriumItem;
...
public class NetheriumOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:netherium_ore")
	public static final Block block = null;
	public NetheriumOreBlock(TheChaosModModElements instance) {
		super(instance, 48);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(NetheriumItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 5)).range(18).square().func_242731_b(5));
	}
}
