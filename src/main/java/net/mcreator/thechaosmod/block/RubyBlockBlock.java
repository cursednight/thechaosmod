...
public class RubyBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(TheChaosModModElements instance) {
		super(instance, 705);
	}
