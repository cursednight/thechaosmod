...
public class WillowPlanksBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:willow_planks")
	public static final Block block = null;
	public WillowPlanksBlock(TheChaosModModElements instance) {
		super(instance, 672);
	}
