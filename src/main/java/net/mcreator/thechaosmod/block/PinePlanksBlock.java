...
public class PinePlanksBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_planks")
	public static final Block block = null;
	public PinePlanksBlock(TheChaosModModElements instance) {
		super(instance, 656);
	}
