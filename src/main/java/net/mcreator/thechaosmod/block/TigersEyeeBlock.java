...
public class TigersEyeeBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:tigers_eyee")
	public static final Block block = null;
	public TigersEyeeBlock(TheChaosModModElements instance) {
		super(instance, 777);
