...
public class SilverBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(TheChaosModModElements instance) {
		super(instance, 303);
	}
