...
public class MachineFrameBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:machine_frame")
	public static final Block block = null;
	public MachineFrameBlock(TheChaosModModElements instance) {
		super(instance, 575);
	}
