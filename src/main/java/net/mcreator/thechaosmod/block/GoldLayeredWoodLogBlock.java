...
public class GoldLayeredWoodLogBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_log")
	public static final Block block = null;
	public GoldLayeredWoodLogBlock(TheChaosModModElements instance) {
		super(instance, 725);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_log");
		}
