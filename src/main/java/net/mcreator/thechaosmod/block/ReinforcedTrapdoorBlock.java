...
public class ReinforcedTrapdoorBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:reinforced_trapdoor")
	public static final Block block = null;
	public ReinforcedTrapdoorBlock(TheChaosModModElements instance) {
		super(instance, 691);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("reinforced_trapdoor");
		}
