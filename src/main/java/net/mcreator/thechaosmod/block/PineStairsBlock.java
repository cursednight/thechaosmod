...
public class PineStairsBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_stairs")
	public static final Block block = null;
	public PineStairsBlock(TheChaosModModElements instance) {
		super(instance, 658);
	}
