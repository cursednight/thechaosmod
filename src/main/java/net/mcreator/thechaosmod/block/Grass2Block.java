...
public class Grass2Block extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:grass_2")
	public static final Block block = null;
	public Grass2Block(TheChaosModModElements instance) {
		super(instance, 621);
	}
