...
public class BronzeBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:bronze_block")
	public static final Block block = null;
	public BronzeBlockBlock(TheChaosModModElements instance) {
		super(instance, 282);
	}
