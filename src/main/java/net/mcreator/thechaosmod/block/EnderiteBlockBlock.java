...
public class EnderiteBlockBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:enderite_block")
	public static final Block block = null;
	public EnderiteBlockBlock(TheChaosModModElements instance) {
		super(instance, 238);
	}
