...
public class Grass3Block extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:grass_3")
	public static final Block block = null;
	public Grass3Block(TheChaosModModElements instance) {
		super(instance, 686);
	}
