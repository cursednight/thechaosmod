...
import net.mcreator.thechaosmod.item.AmythesttItem;
...
public class AmythesttOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:amythestt_ore")
	public static final Block block = null;
	public AmythesttOreBlock(TheChaosModModElements instance) {
		super(instance, 800);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AmythesttItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
