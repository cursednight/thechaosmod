...
public class VoidStoneWallBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:void_stone_wall")
	public static final Block block = null;
	public VoidStoneWallBlock(TheChaosModModElements instance) {
		super(instance, 377);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.2f, 6f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("void_stone_wall");
		}
