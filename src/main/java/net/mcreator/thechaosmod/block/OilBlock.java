...
public class OilBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("the_chaos_mod:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(TheChaosModModElements instance) {
		super(instance, 347);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("the_chaos_mod:blocks/oil"), new ResourceLocation("the_chaos_mod:blocks/oil"))
						.luminosity(30).density(1000).viscosity(4000)).bucket(() -> bucket).block(() -> block);
