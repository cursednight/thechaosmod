...
public class PineFenceBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_fence")
	public static final Block block = null;
	public PineFenceBlock(TheChaosModModElements instance) {
		super(instance, 660);
	}
