...
public class CrystalTreeSlabBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_slab")
	public static final Block block = null;
	public CrystalTreeSlabBlock(TheChaosModModElements instance) {
		super(instance, 764);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_slab");
		}
