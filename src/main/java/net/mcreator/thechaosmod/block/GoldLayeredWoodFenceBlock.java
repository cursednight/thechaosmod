...
public class GoldLayeredWoodFenceBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_fence")
	public static final Block block = null;
	public GoldLayeredWoodFenceBlock(TheChaosModModElements instance) {
		super(instance, 730);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_fence");
		}
