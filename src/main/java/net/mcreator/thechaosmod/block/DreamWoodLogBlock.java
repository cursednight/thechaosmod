...
public class DreamWoodLogBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_log")
	public static final Block block = null;
	public DreamWoodLogBlock(TheChaosModModElements instance) {
		super(instance, 744);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_log");
		}
