...
public class GoldLayeredWoodFenceGateBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_fence_gate")
	public static final Block block = null;
	public GoldLayeredWoodFenceGateBlock(TheChaosModModElements instance) {
		super(instance, 731);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_fence_gate");
		}
