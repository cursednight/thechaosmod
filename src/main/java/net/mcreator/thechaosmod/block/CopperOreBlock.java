...
public class CopperOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TheChaosModModElements instance) {
		super(instance, 92);
