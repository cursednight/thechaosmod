...
import net.mcreator.thechaosmod.procedures.AcidMobplayerCollidesBlockProcedure;
...
public class AcidBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("the_chaos_mod:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(TheChaosModModElements instance) {
		super(instance, 4);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("the_chaos_mod:blocks/acid"), new ResourceLocation("the_chaos_mod:blocks/acid"))
						.luminosity(22).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
