...
public class PineFenceGateBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:pine_fence_gate")
	public static final Block block = null;
	public PineFenceGateBlock(TheChaosModModElements instance) {
		super(instance, 661);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("pine_fence_gate");
		}
