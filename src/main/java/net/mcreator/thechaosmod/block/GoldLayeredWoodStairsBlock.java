...
public class GoldLayeredWoodStairsBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_stairs")
	public static final Block block = null;
	public GoldLayeredWoodStairsBlock(TheChaosModModElements instance) {
		super(instance, 728);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_stairs");
		}
