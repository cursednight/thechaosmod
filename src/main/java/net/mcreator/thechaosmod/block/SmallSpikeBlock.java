...
public class SmallSpikeBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:small_spike")
	public static final Block block = null;
	public SmallSpikeBlock(TheChaosModModElements instance) {
		super(instance, 464);
