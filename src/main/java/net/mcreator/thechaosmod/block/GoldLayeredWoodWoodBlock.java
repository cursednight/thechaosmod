...
public class GoldLayeredWoodWoodBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:gold_layered_wood_wood")
	public static final Block block = null;
	public GoldLayeredWoodWoodBlock(TheChaosModModElements instance) {
		super(instance, 724);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gold_layered_wood_wood");
		}
