...
public class DreamWoodFenceBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_fence")
	public static final Block block = null;
	public DreamWoodFenceBlock(TheChaosModModElements instance) {
		super(instance, 749);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_fence");
		}
