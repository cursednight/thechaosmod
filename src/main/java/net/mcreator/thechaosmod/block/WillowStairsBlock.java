...
public class WillowStairsBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:willow_stairs")
	public static final Block block = null;
	public WillowStairsBlock(TheChaosModModElements instance) {
		super(instance, 674);
	}
