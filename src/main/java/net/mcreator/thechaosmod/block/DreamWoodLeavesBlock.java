...
public class DreamWoodLeavesBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_leaves")
	public static final Block block = null;
	public DreamWoodLeavesBlock(TheChaosModModElements instance) {
		super(instance, 746);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_leaves");
		}
