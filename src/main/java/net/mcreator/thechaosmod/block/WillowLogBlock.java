...
public class WillowLogBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:willow_log")
	public static final Block block = null;
	public WillowLogBlock(TheChaosModModElements instance) {
		super(instance, 671);
	}
