...
public class CrystalTreeStairsBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:crystal_tree_stairs")
	public static final Block block = null;
	public CrystalTreeStairsBlock(TheChaosModModElements instance) {
		super(instance, 763);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crystal_tree_stairs");
		}
