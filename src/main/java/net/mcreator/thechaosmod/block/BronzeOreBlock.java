...
public class BronzeOreBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:bronze_ore")
	public static final Block block = null;
	public BronzeOreBlock(TheChaosModModElements instance) {
		super(instance, 281);
