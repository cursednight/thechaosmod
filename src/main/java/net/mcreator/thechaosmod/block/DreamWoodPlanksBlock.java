...
public class DreamWoodPlanksBlock extends TheChaosModModElements.ModElement {
	@ObjectHolder("the_chaos_mod:dream_wood_planks")
	public static final Block block = null;
	public DreamWoodPlanksBlock(TheChaosModModElements instance) {
		super(instance, 745);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dream_wood_planks");
		}
