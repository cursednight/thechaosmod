...
public class MultiblocknvinventoryGui extends TheChaosModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public MultiblocknvinventoryGui(TheChaosModModElements instance) {
		super(instance, 401);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("multiblocknvinventory"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("the_chaos_mod:textures/multiblocknvinventory.png");
		@Override
