...
import net.mcreator.thechaosmod.procedures.LockButtonProcedure;
...
public class SafeInventoryGui extends TheChaosModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public SafeInventoryGui(TheChaosModModElements instance) {
		super(instance, 597);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("safe_inventory"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("the_chaos_mod:textures/safe_inventory.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 63, this.guiTop + 61, 45, 20, new StringTextComponent("lock"), e -> {
		...
		if (buttonID == 0) {
			{
				...
				LockButtonProcedure.executeProcedure($_dependencies);
			}
		}
	}
