...
public class AgiProcedure extends TheChaosModModElements.ModElement {
	public AgiProcedure(TheChaosModModElements instance) {
		super(instance, 489);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency entity for procedure Agi!");
			return;
		}
