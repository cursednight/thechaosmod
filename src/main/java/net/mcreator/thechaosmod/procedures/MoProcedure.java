...
import net.mcreator.thechaosmod.block.DimensionalLuckyBlockBlock;
...
public class MoProcedure extends TheChaosModModElements.ModElement {
	public MoProcedure(TheChaosModModElements instance) {
		super(instance, 406);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency x for procedure Mo!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency y for procedure Mo!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency z for procedure Mo!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency world for procedure Mo!");
			return;
		}
		...
		if ((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Blocks.OBSIDIAN, (int) (1)).getItem())
						&& (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(Blocks.OBSIDIAN, (int) (1))
								.getItem()) && (((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
											...
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(Blocks.OBSIDIAN, (int) (1)).getItem()) && (((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														...
														.getItem() == new ItemStack(Blocks.DROPPER, (int) (1)).getItem()) && (((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
																TileEntity _ent = world.getTileEntity(pos);
																if (_ent != null) {
																			...
																			public ItemStack getItemStack(BlockPos pos, int sltid) {
																				...
																				&& (((new Object() {
																					public ItemStack getItemStack(BlockPos pos, int sltid) {
																						...
																						.getItem() == new ItemStack(Blocks.DROPPER, (int) (1))
																								.getItem())
																						&& (((new Object() {
																							public ItemStack getItemStack(BlockPos pos, int sltid) {
																								AtomicReference<ItemStack> _retval = new AtomicReference<>(
																								...
																								(int) (10)))
																										.getItem() == new ItemStack(Blocks.DROPPER,
																												(int) (1)).getItem())
																								&& (((new Object() {
				...
				&& ((((new Object() {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getItem() == new ItemStack(DimensionalLuckyBlockBlock.block, (int) (1)).getItem())) || (!((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(DimensionalLuckyBlockBlock.block, (int) (1));
