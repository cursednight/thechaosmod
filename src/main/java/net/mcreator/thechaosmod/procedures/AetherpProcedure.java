...
public class AetherpProcedure extends TheChaosModModElements.ModElement {
	public AetherpProcedure(TheChaosModModElements instance) {
		super(instance, 571);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheChaosModMod.LOGGER.warn("Failed to load dependency entity for procedure Aetherp!");
			return;
		}
